  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-4 px-4 pt-4">
        ...
        <div className="card !mb-0 flex items-center gap-3 border-[var(--gold-light)] bg-[linear-gradient(135deg,rgba(255,218,164,0.1),rgba(158,124,69,0.04))]">
        ...
        <div className="grid2">
          ...
          <Link href="/earn/submit" className="card !mb-0 cursor-pointer text-center">
            <div className="card-icon">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8}>
          ...
          <Link href="/earn/social" className="card !mb-0 cursor-pointer text-center">
            <div className="card-icon">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8}>
                <path d="M12 3l1.8 5.4L19 10l-5.2 1.6L12 17l-1.8-5.4L5 10l5.2-1.6z" />
              </svg>
